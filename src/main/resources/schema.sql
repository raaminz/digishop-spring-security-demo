...
create table ADDRESSES (   address_id        NUMBER(15) not null,   address1          VARCHAR2(40) not null,   address2          VARCHAR2(40),   city              VARCHAR2(40) not null,   postal_code       VARCHAR2(12),   state_province    VARCHAR2(40) not null,   country_id        CHAR(2) not null,   longitude         NUMBER,   latitude          NUMBER,created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null );
...
create table SUPPLIERS (   supplier_id       NUMBER(15) not null,   supplier_name     VARCHAR2(120) not null,   supplier_status   VARCHAR2(30) not null,   phone_number      VARCHAR2(20),   email             VARCHAR2(255),   ui_skin           VARCHAR2(60),created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table MEMBERSHIPS_BASE (   membership_id        NUMBER(15) not null,   membership_type_code VARCHAR2(30) not null,   contact_id           NUMBER(15) not null,created_by           VARCHAR2(60) not null,   creation_date        DATE not null,   last_updated_by      VARCHAR2(60) not null,   last_update_date     DATE not null,   object_version_id    NUMBER(15) not null ) ;
...
create table PERSONS (   person_id                   NUMBER(15) not null,   principal_name              VARCHAR2(60) not null,   title                       VARCHAR2(12),   first_name                  VARCHAR2(30),   last_name                   VARCHAR2(30),   person_type_code            VARCHAR2(30) not null,   supplier_id                 NUMBER(15),   provisioned_flag            VARCHAR2(1) default 'N',   primary_address_id          NUMBER(15),   registered_date             DATE,   membership_id               NUMBER(15),   email                       VARCHAR2(25) not null,   confirmed_email             VARCHAR2(25),   phone_number                VARCHAR2(20),   mobile_phone_number         VARCHAR2(20),   credit_limit                NUMBER(9,2),   date_of_birth               DATE,   marital_status_code         VARCHAR2(30) not null,   gender                      VARCHAR2(1) not null,   children_under_18           NUMBER(2),   approximate_income          NUMBER(15),   contact_method_code         VARCHAR2(30),   contactable_flag            VARCHAR2(1) default 'Y' not null,   contact_by_affilliates_flag VARCHAR2(1) default 'Y' not null,created_by                  VARCHAR2(60) not null,   creation_date               DATE not null,   last_updated_by             VARCHAR2(60) not null,   last_update_date            DATE not null,   object_version_id           NUMBER(15) not null ) ;
...
create table ADDRESS_USAGES (   address_usages_id   NUMBER not null,   associated_owner_id NUMBER(15) not null,   owner_type_code     VARCHAR2(30) not null,   address_id          NUMBER(15) not null,   usage_type_code     VARCHAR2(30) not null,   expired_flag        VARCHAR2(1) default 'N' not null,created_by          VARCHAR2(60) not null,   creation_date       DATE not null,   last_updated_by     VARCHAR2(60) not null,   last_update_date    DATE not null,   object_version_id   NUMBER(15) not null ) ;
...
create table AVAILABLE_LANGUAGES (   language          VARCHAR2(30) not null,   default_flag      VARCHAR2(1) default 'N' not null,created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table PRODUCT_CATEGORIES_BASE (   category_id               NUMBER(15) not null,   parent_category_id        NUMBER(15),   category_locked_flag      VARCHAR2(1) default 'N' not null,   representative_product_id NUMBER(15),created_by                VARCHAR2(60) not null,   creation_date             DATE not null,   last_updated_by           VARCHAR2(60) not null,   last_update_date          DATE not null,   object_version_id         NUMBER(15) not null );

create table PRODUCTS_BASE (   product_id             NUMBER(15) not null,   supplier_id            NUMBER(15) not null,   parent_category_id     NUMBER(15),   category_id            NUMBER(15),   product_name           VARCHAR2(50) not null,   product_status         VARCHAR2(30) not null,   cost_price             NUMBER(8,2),   list_price             NUMBER(8,2) not null,   min_price              NUMBER(8,2) not null,   warranty_period_months NUMBER(2),   shipping_class_code    VARCHAR2(30) not null,   external_url           VARCHAR2(200),   attribute_category     VARCHAR2(30),   attribute1             VARCHAR2(150),   attribute2             VARCHAR2(150),   attribute3             VARCHAR2(150),   attribute4             VARCHAR2(150),   attribute5             VARCHAR2(150),   attribute6             VARCHAR2(150),   attribute7             VARCHAR2(150),   attribute8             VARCHAR2(150),   attribute9             VARCHAR2(150),   attribute10            VARCHAR2(150),   attribute11            VARCHAR2(150),   attribute12            VARCHAR2(150),   attribute13            VARCHAR2(150),   attribute14            VARCHAR2(150),   attribute15            VARCHAR2(150),created_by             VARCHAR2(60) not null,   creation_date          DATE not null,   last_updated_by        VARCHAR2(60) not null,   last_update_date       DATE not null,   object_version_id      NUMBER(15) not null ) ;
...
comment on column PRODUCTS_BASE.warranty_period_months  is 'How NUMBER(15) is the warantee for this product';
...
create table CATEGORY_TRANSLATIONS (   category_id          NUMBER(15) not null,   category_name        VARCHAR2(50) not null,   category_description VARCHAR2(1000),   language             VARCHAR2(30) not null,   source_lang          VARCHAR2(30),created_by           VARCHAR2(60) not null,   creation_date        DATE not null,   last_updated_by      VARCHAR2(60) not null,   last_update_date     DATE not null,   object_version_id    NUMBER(15) not null ) ;
...
create table COUNTRY_CODES (   iso_country_code  VARCHAR2(2) not null,   country_name      VARCHAR2(100),   language          VARCHAR2(30) not null,   source_lang       VARCHAR2(30),created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table DISCOUNTS_BASE (   discount_id              NUMBER(15) not null,   discount_type_code       VARCHAR2(30) not null,   discount_amount          NUMBER not null,   apply_as_percentage_flag VARCHAR2(1) default 'N' not null,   easy_code                VARCHAR2(20),   add_free_shipping_flag   VARCHAR2(1) default 'N' not null,   onetime_discount_flag    VARCHAR2(1) default 'Y' not null,created_by               VARCHAR2(60) not null,   creation_date            DATE not null,   last_updated_by          VARCHAR2(60) not null,   last_update_date         DATE not null,   object_version_id        NUMBER(15) not null ) ;
...
create table PAYMENT_OPTIONS (   payment_option_id  NUMBER(16) not null,   customer_id        NUMBER(15) not null,   payment_type_code  VARCHAR2(30) not null,   billing_address_id INTEGER,   account_number     NUMBER(19) not null,   card_type_code     VARCHAR2(30),   expire_date        DATE,   check_digits       NUMBER(4),   routing_identifier VARCHAR2(15),   institution_name   VARCHAR2(120),   valid_from_date    DATE,   valid_to_date      DATE,created_by         VARCHAR2(60) not null,   creation_date      DATE not null,   last_updated_by    VARCHAR2(60) not null,   last_update_date   DATE not null,   object_version_id  NUMBER(15) not null ) ;
...
create table SHIPPING_OPTIONS_BASE (   shipping_option_id         NUMBER(15) not null,   country_code               VARCHAR2(2),   cost_per_class1_item       NUMBER(8,2) not null,   cost_per_class2_item       NUMBER(8,2) not null,   cost_per_class3_item       NUMBER(8,2) not null,   free_shipping_allowed_flag VARCHAR2(1) default 'N',created_by                 VARCHAR2(60) not null,   creation_date              DATE not null,   last_updated_by            VARCHAR2(60) not null,   last_update_date           DATE not null,   object_version_id          NUMBER(15) not null ) ;
...
create table WAREHOUSES (   warehouse_id      NUMBER(15) not null,   address_id        NUMBER(15) not null,   warehouse_name    VARCHAR2(35) not null,created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table ORDERS (   order_id                NUMBER(15) not null,   order_date              DATE not null,   order_shipped_date      DATE,   order_status_code       VARCHAR2(30) not null,   order_total             NUMBER(8,2) not null,   customer_id             NUMBER(15) not null,   ship_to_name            VARCHAR2(120),   ship_to_address_id      NUMBER(15) not null,   ship_to_phone_number    VARCHAR2(20),   shipping_option_id      NUMBER(15) not null,   payment_option_id       NUMBER(16),   discount_id             NUMBER(15),   coupon_id               NUMBER(15),   free_shipping_flag      VARCHAR2(1) default 'N' not null,   customer_collect_flag   VARCHAR2(1) default 'N' not null,   collection_warehouse_id NUMBER(15),   giftwrap_flag           VARCHAR2(1) default 'N' not null,   giftwrap_message        VARCHAR2(2000),created_by              VARCHAR2(60) not null,   creation_date           DATE not null,   last_updated_by         VARCHAR2(60) not null,   last_update_date        DATE not null,   object_version_id       NUMBER(15) not null ) ;
...
create table COUPON_USAGES (   customer_id       NUMBER(15) not null,   discount_id       NUMBER(15) not null,   applied_date      DATE not null,   order_id          NUMBER(15) not null,created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table CUSTOMER_IDENTIFICATIONS (   customer_id              NUMBER(15) not null,   id_type_code             VARCHAR2(30) not null,   id_detail                VARCHAR2(20) not null,   additional_information   VARCHAR2(1000),   verified_flag            VARCHAR2(1) default 'N' not null,   verified_date            DATE,   verified_by              NUMBER(15),   verification_method_code VARCHAR2(30),created_by               VARCHAR2(60) not null,   creation_date            DATE not null,   last_updated_by          VARCHAR2(60) not null,   last_update_date         DATE not null,   object_version_id        NUMBER(15) not null ) ;
...
create table CUSTOMER_INTERESTS (   customer_id           NUMBER(15) not null,   customer_interests_id NUMBER(15) not null,   category_id           NUMBER(15) not null,created_by            VARCHAR2(60) not null,   creation_date         DATE not null,   last_updated_by       VARCHAR2(60) not null,   last_update_date      DATE not null,   object_version_id     NUMBER(15) not null ) ;
...
create table DEMO_OPTIONS (   key   VARCHAR2(40) not null,   value          VARCHAR2(120),   java_data_type VARCHAR2(120) default 'java.lang.String' not null,   description    VARCHAR2(4000) not null ) ;
...
create table DISCOUNT_TRANSLATIONS (   discount_translations_id NUMBER(15) not null,   discount_id              NUMBER(15) not null,   description              VARCHAR2(4000) not null,   language                 VARCHAR2(30) not null,   source_language          VARCHAR2(15) not null,created_by               VARCHAR2(60) not null,   creation_date            DATE not null,   last_updated_by          VARCHAR2(60) not null,   last_update_date         DATE not null,   object_version_id        NUMBER(15) not null ) ;
...
create table ELIGIBLE_DISCOUNTS (   membership_id     NUMBER(15) not null,   discount_id       NUMBER(15) not null,   valid_from_date   DATE,   valid_to_date     DATE,created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table HELP_TRANSLATIONS (   help_translations_id NUMBER(15) not null,   help_id              NUMBER(15) not null,   help_usage           VARCHAR2(200) not null,   help_text            VARCHAR2(2000) not null,   language             VARCHAR2(30) not null,   source_language      VARCHAR2(15) not null,created_by           VARCHAR2(60) not null,   creation_date        DATE not null,   last_updated_by      VARCHAR2(60) not null,   last_update_date     DATE not null,   object_version_id    NUMBER(15) not null ) ;
...
create table LOOKUP_CODES (   lookup_type       VARCHAR2(30) not null,   lookup_code       VARCHAR2(30) not null,   meaning           VARCHAR2(80) not null,   description       VARCHAR2(240),   language          VARCHAR2(30) not null,   source_lang       VARCHAR2(30) not null,created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table MEMBERSHIP_TRANSLATIONS (   membership_translations_id NUMBER(15) not null,   membership_id              NUMBER(15) not null,   membership_name            VARCHAR2(120) not null,   description                VARCHAR2(2000),   language                   VARCHAR2(30) not null,   source_language            VARCHAR2(15) not null,created_by                 VARCHAR2(60) not null,   creation_date              DATE not null,   last_updated_by            VARCHAR2(60) not null,   last_update_date           DATE not null,   object_version_id          NUMBER(15) not null ) ;
...
create table ORDER_ITEMS (   order_id          NUMBER(15) not null,   line_item_id      NUMBER(15) not null,   product_id        NUMBER(15) not null,   quantity          NUMBER(6) default 1 not null,   unit_price        NUMBER(8,2) not null,created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table PRODUCT_IMAGES (   product_image_id  NUMBER(15) not null,   product_id        NUMBER(15) not null,   default_view_flag VARCHAR2(1) default 'N' not null,   detail_image_id   NUMBER(15),   image             BLOB not null,created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table PRODUCT_TRANSLATIONS (   product_id        NUMBER(15) not null,   language          VARCHAR2(30) not null,   source_lang       VARCHAR2(30),   description       VARCHAR2(4000) not null,   additional_info   VARCHAR2(4000),created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null ) ;
...
create table SHIPPING_OPTION_TRANSLATIONS (   shipping_translations_id NUMBER(15) not null,   shipping_option_id       NUMBER(15) not null,   shipping_method          VARCHAR2(100) not null,   language                 VARCHAR2(30) not null,   source_lang              VARCHAR2(4000) not null,created_by               VARCHAR2(60) not null,   creation_date            DATE not null,   last_updated_by          VARCHAR2(60) not null,   last_update_date         DATE not null,   object_version_id        NUMBER(15) not null ) ;
...
create table WAREHOUSE_STOCK_LEVELS (   product_id        NUMBER(15) not null,   warehouse_id      NUMBER(15) not null,   quantity_on_hand  NUMBER(8) not null,created_by        VARCHAR2(60) not null,   creation_date     DATE not null,   last_updated_by   VARCHAR2(60) not null,   last_update_date  DATE not null,   object_version_id NUMBER(15) not null );
...
create table USER (id NUMBER(15) not null,   username VARCHAR2(40) not null,   password  VARCHAR2(80) not null);
alter table USER   add constraint USER_PK primary key (id);
alter table USER   add constraint USER_NAME_UK unique key (username);

create table ROLE (id NUMBER(15) not null,   name VARCHAR2(20) not null);
alter table ROLE  add constraint ROLE_PK primary key (id);
alter table ROLE  add constraint ROLE_NAME_UK unique key (name);

create table user_role(user_id NUMBER(15) not null,   role_id Number(15) not null);
